...
import { CellField, CellInterface } from "../../../interfaces/interfaces";
...
function moveCheck(cells: CellField, currentID: number, endCellId: number) {
